...
// Reference: http://www.mattkruse.com/javascript/date/
.filter('stringToDate', ['$locale', function($locale) {
      ...
      function parseDate(viewValue) {
        if (!viewValue) {
          ...
          return viewValue;
            ...
            var date = $filter('stringToDate')(viewValue, dateFormat) || new Date(viewValue);
          if (isNaN(date)) {
